...
$$
x_{n+1} := g(x_n), \quad \text{para } n=0,1,2,\dots
$$
...
Sea $$f(x) = e^{-x}$$, es fácil probar que $$f(x)$$ mapea  
$$A = [0.5, 0.69]$$ en sí mismo (ejercicio).  
...
![El Método de la Secante](Imagenes/MetodoNR.png){width=400px fig-align="center"}
